        ...
        <section class="py-12">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="profile" 
                       class="flex items-center justify-center px-8 py-4 gradient-bg hover:shadow-2xl text-white font-bold rounded-xl transition-all transform hover:scale-105">
                        Thanh Toán
                    </a>
                </div>
